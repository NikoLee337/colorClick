...
public class GameView24 extends AppCompatActivity {
    //buttons
    ...
    public void openGameView25() {
        Intent intent = new Intent(this, GameView25.class);
        count.cancel();
        startActivity(intent);
    }

    public void checkvisi(){
        if(btn_12.getVisibility() == View.INVISIBLE && btn_03.getVisibility() == View.INVISIBLE && btn_23.getVisibility() == View.INVISIBLE){
            count.cancel();
            openGameView25();
        }
    }
