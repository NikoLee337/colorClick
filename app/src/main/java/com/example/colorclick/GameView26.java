...
public class GameView26 extends AppCompatActivity {
    //buttons
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game26);
    ...
    public void openGameView27() {
        Intent intent = new Intent(this, GameView27.class);
        count.cancel();
        startActivity(intent);
    }

    public void checkvisi(){
        if(btn_01.getVisibility() == View.INVISIBLE && btn_02.getVisibility() == View.INVISIBLE && btn_13.getVisibility() == View.INVISIBLE && btn_32.getVisibility() == View.INVISIBLE && btn_33.getVisibility() == View.INVISIBLE){
            count.cancel();
            openGameView27();
        }
    }
