...
public class GameView23 extends AppCompatActivity {
    //buttons
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game23);
    ...
    public void openGameView24() {
        Intent intent = new Intent(this, GameView24.class);
        count.cancel();
        startActivity(intent);
    }

    public void checkvisi(){
        if(btn_02.getVisibility() == View.INVISIBLE && btn_13.getVisibility() == View.INVISIBLE && btn_21.getVisibility() == View.INVISIBLE && btn_32.getVisibility() == View.INVISIBLE){
            count.cancel();
            openGameView24();
        }
    }
