...
public class GameView15 extends AppCompatActivity {
    //buttons
    ...
    public void openGameView16() {
        Intent intent = new Intent(this, GameView16.class);
        count.cancel();
        startActivity(intent);
    }

    public void checkvisi(){
        if(btn_12.getVisibility() == View.INVISIBLE){
            count.cancel();
            openGameView16();
        }
    }
