...
public class GameView29 extends AppCompatActivity {
    //buttons
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game29);
    ...
    public void openGameView30() {
        Intent intent = new Intent(this, GameView30.class);
        count.cancel();
        startActivity(intent);
    }
