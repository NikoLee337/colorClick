...
public class GameView13 extends AppCompatActivity {
    //buttons
    ...
    public void checkvisi(){
        if(btn_02.getVisibility() == View.INVISIBLE && btn_21.getVisibility() == View.INVISIBLE && btn_32.getVisibility() == View.INVISIBLE){
            count.cancel();
            openGameView14();
        }
    }
