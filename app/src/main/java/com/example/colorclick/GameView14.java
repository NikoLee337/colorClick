...
public class GameView14 extends AppCompatActivity {
    //buttons
    ...
    public void openGameView15() {
        Intent intent = new Intent(this, GameView15.class);
        count.cancel();
        startActivity(intent);
    }

    public void checkvisi(){
        if(btn_01.getVisibility() == View.INVISIBLE && btn_31.getVisibility() == View.INVISIBLE){
            count.cancel();
            openGameView15();
        }
    }
