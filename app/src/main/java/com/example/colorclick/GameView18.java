...
public class GameView18 extends AppCompatActivity {
    //buttons
    ...
    public void openGameView19() {
        Intent intent = new Intent(this, GameView19.class);
        count.cancel();
        startActivity(intent);
    }

    public void checkvisi(){
        if(btn_22.getVisibility() == View.INVISIBLE){
            count.cancel();
            openGameView19();
        }
    }
